...
namespace Routine.Api.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public async Task<IActionResult> PartiallUpdateEmployeeForCompany(Guid companyId, Guid employeeId,
            JsonPatchDocument<EmployeeUpdateDto> patchDocument)
        {
            ...
            if (employeeEntity == null)
            {
                ...
                return CreatedAtRoute(nameof(GetEmployeeForCompany), new { companyId = companyId, employeeId = dtoToReturn.Id },
                    dtoToReturn);
            }
