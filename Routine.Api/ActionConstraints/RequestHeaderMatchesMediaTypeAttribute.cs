...
namespace Routine.Api.ActionConstraints
{
    ...
    public class RequestHeaderMatchesMediaTypeAttribute : Attribute, IActionConstraint
    {
        ...
        private readonly MediaTypeCollection _miMediaTypes = new MediaTypeCollection();
            ...
            string mediaType, params string[] otherMediaTypes)
        {
            ...
            {
                _miMediaTypes.Add(parsedMediaType);
            }
            else
            {
            ...
            foreach (var otherMediaType in otherMediaTypes)
            {
                ...
                {
                    _miMediaTypes.Add(parsedOtherMediaType);
                }
                else
                {
        ...
        public bool Accept(ActionConstraintContext context)
        {
            ...
            foreach (var mediaType in _miMediaTypes)
            {
